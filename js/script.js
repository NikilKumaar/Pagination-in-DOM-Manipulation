...
function rendering(page) {
  const table = document.querySelector("#table-body");
  table.innerHTML = "";

  const start = (page - 1) * datas; //1-1 * 10
  const end = start + datas; //0+10
  ...
  for (let i = start; i < end; i++) {
    ...
    cell1.innerText = jsonData[i].id;
    cell2.innerText = jsonData[i].name;
    cell3.innerText = jsonData[i].email;
  }
}
...
function navigation(direction) {
  if (direction === "previous" && currentPage > 1) {
    ...
    currentPage = 1;
  } else if (direction === "second" && currentPage != 2) {
    currentPage = 2;
  } else if (direction === "third" && currentPage != 3) {
    currentPage = 3;
  } else if (direction === "fourth" && currentPage != 4) {
    currentPage = 4;
  } else if (direction === "fifth" && currentPage != 5) {
    currentPage = 5;
  } else if (direction === "sixth" && currentPage != 6) {
    currentPage = 6;
  } else if (direction === "seventh" && currentPage != 7) {
    currentPage = 7;
  } else if (direction === "eighth" && currentPage != 8) {
    currentPage = 8;
  } else if (direction === "nineth" && currentPage != 9) {
    currentPage = 9;
  } else if (direction === "tenth" && currentPage != 10) {
    currentPage = 10;
  }
...
document
  ...
  .addEventListener("click", () => navigation("previous"));
document
  .querySelector("#nextPage")
  .addEventListener("click", () => navigation("next"));
document
  .querySelector("#first")
  .addEventListener("click", () => navigation("first"));
document
  .querySelector("#second")
  .addEventListener("click", () => navigation("second"));
document
  .querySelector("#third")
  .addEventListener("click", () => navigation("third"));
document
  .querySelector("#fourth")
  .addEventListener("click", () => navigation("fourth"));
document
  .querySelector("#fifth")
  .addEventListener("click", () => navigation("fifth"));
document
  .querySelector("#sixth")
  .addEventListener("click", () => navigation("sixth"));
document
  .querySelector("#seventh")
  .addEventListener("click", () => navigation("seventh"));
document
  .querySelector("#eighth")
  .addEventListener("click", () => navigation("eigth"));
document
  .querySelector("#nineth")
  .addEventListener("click", () => navigation("nineth"));
document
  .querySelector("#tenth")
  .addEventListener("click", () => navigation("tenth"));
